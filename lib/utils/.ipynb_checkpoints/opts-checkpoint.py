...
class opts(object):
    def __init__(self):
        ...
        self.parser.add_argument('--model_name', default='DSFNet',
                                 help='name of the model. DSFNet | DSFNet_with_Static | DSFNet_with_Dynamic | SparseEnsembleMoE_DSFNet | AMENet')
        ...
        self.parser.add_argument('--n_active_experts', type=int, default=60,
                                 help='Number of active experts to use for AMENet inference.')
        # save & dataset
